...
interface Order {
  ...
  status: string;
  cartItems: {
    image: React.JSX.Element; productName: string; imageURL: string 
}[];
}
...
export default function AdminDashboard() {
  ...
  useEffect(() => {
    client
      ...
      .then((data) => setOrders(data ?? [])) // Nullish coalescing to ensure array
      .catch((error) => {
        console.error("Error fetching orders:", error);
        setOrders([]); // Error case pe bhi empty array
      });
  }, []);
  // useEffect(() => {
  //   client
  ...
  //       }`
  //     )
  //     .then((data) => setOrders(data ?? [])) // Ensure array response
  //     .catch((error) => {
  //       console.error("Error fetching orders:", error);
  //       setOrders([]);
  //     });
